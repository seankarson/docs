...
/***/ function(module, exports, __webpack_require__) {
	...
	var DeepSideSubnavGenerator = __webpack_require__(1);
	...
	$(function () {
	  ...
	  var deepSideSubnavGenerator = new DeepSideSubnavGenerator(apiClient, renderer);
	  ...
	  deepSideSubnavGenerator.generate_from(url, $rootElement[0]);
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var resolveRelativePath = _require.resolveRelativePath;

	function DeepSideSubnavGenerator(apiClient, renderer) {

	  this.generate_from = function (url, rootElement) {
	    apiClient.getResource(url, function (jsonForNav) {
	      cleanUrls(jsonForNav.links);
	      renderer.render(jsonForNav, rootElement);
	    });
	  };

	  function cleanUrls(links) {
	    for (var i = 0; i < links.length; i++) {
	      links[i].url = resolveRelativePath(links[i].url);
	...
	module.exports = DeepSideSubnavGenerator;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DeepSideSubnav = __webpack_require__(6);

	function Renderer() {
	  this.render = function (props, on_element) {
	    React.render(React.createElement(DeepSideSubnav, props), on_element);
	  };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getFullPath = _require2.getFullPath;

	var DeepSideSubnav = React.createClass({
	  displayName: "DeepSideSubnav",

	  getInitialState: function getInitialState() {
	    return { activeLinkUrl: getFullPath() };
	  },
	  ...
	  setActiveLink: function setActiveLink(url) {
	    this.setState({ activeLinkUrl: url });
	  },
	  ...
	  render: function render() {
	    ...
	    var activeLinkUrl = this.state.activeLinkUrl;

	    return React.createElement(Links, { links: links, activeLinkUrl: activeLinkUrl, getFullPath: this.getFullPath, setActiveLink: this.setActiveLink });
	  }

	});

	module.exports = DeepSideSubnav;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getFullPath = _require.getFullPath;
	...
	var Links = React.createClass({
	  ...
	  renderLinks: function renderLinks() {
	    ...
	    var activeLinkUrl = _props.activeLinkUrl;
	    var getFullPath = _props.getFullPath;
	    var setActiveLink = _props.setActiveLink;
	    var parent = _props.parent;

	    return links.map(function (link, key) {
	      return React.createElement(Link, { link: link, key: key, active: link.url === activeLinkUrl, activeLinkUrl: activeLinkUrl, openParent: this.openParent, onSelect: setActiveLink, getFullPath: getFullPath, parent: parent });
	    }, this);
	  },
	...
	var Link = React.createClass({
	  ...
	  handleClick: function handleClick(e) {
	    this.props.onSelect(this.props.link.url);
	  },

	  componentDidMount: function componentDidMount() {
	    var fullPath = getFullPath();
	    var linkUrl = this.props.link.url;
	  ...
	  render: function render() {
	    ...
	    var url = link.url;
	    var text = link.text;
	    var nestedLinks = link.nestedLinks;
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        "span",
	        { className: "topic", key: key },
	        React.createElement(
	          "span",
	          { className: cx({ hasSubMenuClosed: nestedLinks, hasSubMenuOpened: nestedLinks && this.state.open }), onClick: this.toggle },
	          React.createElement(
	            "a",
	            { className: cx({ active: active }), href: url, onClick: this.handleClick },
	            text
	          )
	        ),
	        nestedLinks && React.createElement(Links, { className: cx({ submenu: true, hidden: !this.state.open }), links: nestedLinks, activeLinkUrl: activeLinkUrl, getFullPath: getFullPath, setActiveLink: onSelect, parent: this })
	      )
	    );
	  }
	});
